...
| 7.2 | ✅ done | 2026-05-06 | 2026-05-06 | Pie chart "Outro" fix (`displayModelName` kebab→Title Case + `gpt` family adicionado em MODEL_COLORS + Top 6 + "Outros (N)" agrega resto). CostByModelChart + ModelPieChart refatorados. |
